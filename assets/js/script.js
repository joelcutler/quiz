...
var scoresUlEl = document.querySelector("#scores-ul");
var countInterval;
...
function displayScores() {
  ...
  scoresUlEl.innerHTML = `
    ${savedScores
      .map(
        (score, index) => `
        <li> ${score.initials + " - " + score.highscore + " points"} </li>
  `
      )
      .join("")}`;
  ...
  //   }
  scoresButtonEl.removeEventListener("click", displayScores);
}
